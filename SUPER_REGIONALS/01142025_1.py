...
###################################################################################
    ...
    # await moveMotor('drop','top',115,100)
    # await drive(-19)
    # await turnLeft(10)
    # await drive(10,200)
    ...
    # await drive(12) 
    # // TODO - Send coral segments to the back of the robot.
    ...
    # await drive(20,200)
     # // TODO - sonar discovery and deliver unidentified creature.
